            ...
            <div className="container">
                <div className="row full-height justify-content-center">
                    ...
                    >
                        ...
                        >
                            <h6 style={{ marginBottom: "0", paddingBottom: "0.75rem" }}>
                                <span>Log In </span>
                                <span>Sign Up</span>
                            </h6>
                            <input
                                        ...
                                        <div className="center-wrap">
                                            ...
                                            >
                                                ...
                                                <div
                                                    style={{ margin: "1rem 0" }}
                                                    onClick={loginUser}
                                                    className="btn m-4 log-in-page-button"
                                                >
                                                    Login
                                                </div>
                                    ...
                                    <div className="card-back">
                                        <div className="center-wrap">
                                            <div style={{ textAlign: "center" }} className="section">
                                                ...
                                                <div className="form-group">
                                                    <select
                                                        style={{ marginBottom: "0.75rem", width: "90%" }}
                                                        onChange={handleSignup}
                                                        type="select"
                                                        className="form-style"
                                                ...
                                                <div
                                                    ...
                                                    onClick={signUp}
                                                    className="btn mt-4 log-in-page-button"
                                                >
                                                    Register
                                                </div>
                                            </div>
